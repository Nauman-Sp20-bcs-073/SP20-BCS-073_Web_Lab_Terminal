...
const Profile = () => {
  ...
  const navigate = useNavigate()
    ...
    useEffect( ()=>{
        ...
        axios.get(`${serverLink}/user/${userObj.email}`)
        .then((res)=>{
                ...
                <div className="d-flex text-black">
                  ...
                  <div className="flex-grow-1 ms-3">
                    ...
                    <div className="d-flex justify-content-start rounded-3 p-2 mb-2"
                      ...
                      <div>
                        <p className="small text-muted mb-1">Todos</p>
                        <p className="mb-0">3</p>
                      </div>
                      <div className="px-3">
                        <p className="small text-muted mb-1">Todos Done</p>
                        <p className="mb-0"></p>
                      </div>
                      <div>
